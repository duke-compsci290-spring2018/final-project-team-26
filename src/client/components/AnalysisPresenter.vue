<template>
		...
		<p v-if="type === 'Sentiment analysis'" id="sentiment-template">On a scale of -1.0 (highly negative) to 1.0 (highly positive), the overall sentiment expressed in the top-level comments analyzed was determined to be {{results.document.label}} with a score of {{results.document.score}}.</p>
