...
<ul>
    ...
    <li v-if="user" @click="signOut" class="signOutButton"><a><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
    <li v-else @click="signInPopup" class="signInButton"><a><span class="glyphicon glyphicon-user"></span>Sign In</a></li>
